...
function Mentoring() {
  ...
  const mentors = [
    {
      ...
      description: "Spring Boot와 JPA를 중심으로 실무 개발을 멘토링합니다.",
      price: "30,000",
      image: "",
      rating: 4.9,
      reviews: 38
    },
    {
      ...
      description: "프론트엔드 기초부터 React 프로젝트까지 함께합니다.",
      price: "25,000",
      image: "",
      rating: 4.8,
      reviews: 24
  ...
  const categories = ["전체", "백엔드", "프론트엔드", "풀스택", "데이터"];

  const filteredMentors =
    category === "전체"
      ? mentors
      : mentors.filter((mentor) => mentor.category === category);
  ...
  return (
    <main className="mentoring-page">
      <section className="mentoring-hero">
        ...
        <div className="mentoring-hero-overlay"></div>

        <div className="mentoring-hero-content">
          <span className="mentoring-eyebrow">EASYS MENTORING</span>
          <h1>멘토링</h1>
          <p>
            막히는 부분을 질문하고
            <br />
      ...
      <section className="mentoring-content">
        <div className="mentoring-intro">
          <div>
            <span className="section-label">FIND YOUR MENTOR</span>
        ...
        >
          ...
          >
            ...
            <div className="mentor-modal-profile">
              ...
              <div>
                <span>{selectedMentor.category}</span>
                <h2>{selectedMentor.name}</h2>
                <p>
                  {selectedMentor.role} · {selectedMentor.career}
                </p>
              </div>
            </div>
            ...
            <div className="mentor-modal-bottom">
              <div>
                <small>1회 상담</small>
                <strong>{selectedMentor.price}원</strong>
              </div>

              <button className="mentor-request-button">
                멘토링 신청하기
              </button>
            </div>
          </div>
