    ...
    <main className="home">
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <span className="hero-small-text">EASYS STUDY</span>
          ...
          <Link to={current.link} className="hero-direct-link">
            {current.linkText}
            <span>→</span>
          </Link>
        </div>
      ...
      <section className="content-section intro-section">
        <span className="section-label center-label">WHY EASYS</span>
        ...
        <div className="card-grid-4">
          ...
          <Link to="/streaming" className="info-card">
          ...
          <Link to="/mentor" className="info-card">
          ...
          <Link to="/study" className="info-card">
          ...
          <Link to="/community" className="info-card">
      ...
      <section className="content-section streaming-section">
        ...
        <div className="section-heading-row">
          ...
          <Link to="/streaming" className="section-more-link">
            더 알아보기
            <span>→</span>
          </Link>
        </div>
        ...
        <div className="streaming-preview-grid">
          ...
          <div className="streaming-preview-card">
      ...
      <section className="content-section mentoring-preview-section">
        ...
        <div className="section-heading-row">
          ...
          <Link to="/mentor" className="section-more-link">
            멘토 더 알아보기
            <span>→</span>
          </Link>
        </div>
        ...
        <div className="home-mentor-grid">
          ...
          <div className="home-mentor-card">
            <div className="home-mentor-profile">
              <div className="home-mentor-avatar">J</div>
          ...
          <div className="home-mentor-card">
            <div className="home-mentor-profile">
              <div className="home-mentor-avatar">P</div>
          ...
          <div className="home-mentor-card">
            <div className="home-mentor-profile">
              <div className="home-mentor-avatar">L</div>
      ...
      <section className="content-section schedule-section">
        ...
        <div className="section-heading-row">
          ...
          {/* 오른쪽 위 */}
          <Link to="/study" className="section-more-link">
            스터디 더 알아보기
            <span>→</span>
          </Link>
        </div>
      ...
      <section className="content-section community-section">
        ...
        <div className="section-heading-row">
          ...
          <Link to="/community" className="section-more-link">
            커뮤니티 더 알아보기
            <span>→</span>
          </Link>
        </div>
        ...
        <div className="community-tabs">
          ...
          <button className="tab">스터디</button>
          <button className="tab">질문</button>
          <button className="tab">자유</button>
        </div>
      ...
      <section className="bottom-banner-section">
        ...
        <div className="bottom-banner-box">
          ...
          <Link to="/study" className="hero-btn">
            스터디 시작하기
          </Link>
